...
urlpatterns = [
    ...
    path('api/create-education/', views.EducatioCreareApiView.as_view(), name='create_education'),
    path('api/rud-education/<int:pk>/', views.EducatioUpdateDeleteRetiveApiView.as_view(), name='rud_education'),
    path('api/create-exprience-work/', views.ExprienceCreateApiView.as_view(), name='exprience_work'),
    path('api/exprience-rud/<int:pk>/', views.ExpriencRetrieveUpdateDestroyAPIView.as_view(), name='rud_exprience_work'),
